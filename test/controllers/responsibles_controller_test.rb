...
class ResponsiblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsible" do
    assert_difference("Responsible.count") do
      post responsibles_url, params: { responsible: { email: @responsible.email, name: @responsible.name, password: @responsible.password } }
    end
  ...
  test "should update responsible" do
    patch responsible_url(@responsible), params: { responsible: { email: @responsible.email, name: @responsible.name, password: @responsible.password } }
