...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { end_date: @classroom.end_date, start_date: @classroom.start_date, status: @classroom.status } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { end_date: @classroom.end_date, start_date: @classroom.start_date, status: @classroom.status } }
