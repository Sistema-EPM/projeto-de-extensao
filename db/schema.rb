...
ActiveRecord::Schema[7.0].define(version: 2023_05_12_235450) do
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["responsible_id"], name: "index_courses_on_responsible_id"
  end
